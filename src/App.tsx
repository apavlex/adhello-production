      ...
      <section className="py-12 bg-white relative overflow-hidden border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 w-full">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center items-center gap-x-6 gap-y-4 md:gap-x-10 transition-all duration-500 overflow-x-auto no-scrollbar py-2">
            ...
            {/* Meta — official filled infinity logo */}
            <div className="flex items-center gap-2 flex-shrink-0">
              <svg width="40" height="20" viewBox="0 0 200 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="mg" x1="0" y1="50" x2="200" y2="50" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#0064E1"/>
                    <stop offset="100%" stopColor="#0082FB"/>
                  </linearGradient>
                </defs>
                <path d="M 25 50 C 25 30 35 15 50 15 C 62 15 70 25 80 40 L 100 68 L 120 40 C 130 25 138 15 150 15 C 165 15 175 30 175 50 C 175 70 165 85 150 85 C 138 85 130 75 120 60 L 100 32 L 80 60 C 70 75 62 85 50 85 C 35 85 25 70 25 50 Z" fill="url(#mg)"/>
              </svg>
