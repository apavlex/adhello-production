      ...
      <section className="py-12 bg-white relative overflow-hidden border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 w-full">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center items-center gap-x-6 gap-y-4 md:gap-x-10 transition-all duration-500 overflow-x-auto no-scrollbar py-2">
            ...
            {/* Meta — lobe-icons/Meta/Color paths */}
            <div className="flex items-center gap-2 flex-shrink-0">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M6.897 4h-.024l-.031 2.615h.022c1.715 0 3.046 1.357 5.94 6.246l.175.297 1.632-2.457C11.454 5.275 9.5 4 6.897 4z" fill="#0082FB"/><path d="M6.873 4C4.95 4.01 3.247 5.258 2.02 7.17l2.265 1.238C5.003 7.325 5.817 6.615 6.657 6.615H6.69l.03-2.611L6.873 4z" fill="#0082FB"/><path d="M2.019 7.17C1.2 8.447.598 9.995.274 11.664l2.523.599c.27-1.39.762-2.685 1.39-3.72L2.02 7.17z" fill="#0082FB"/><path d="M13.13 10.303l-1.62 2.438 2.148 3.64 1.627-2.442-2.155-3.636z" fill="#0082FB"/><path d="M17.103 4c-2.601 0-4.552 1.272-7.685 6.7l1.625 2.44C14.128 7.556 15.74 6.615 17.103 6.615c1.518 0 2.84 1.136 3.774 3.03l2.304-1.396C22.015 5.823 19.872 4 17.103 4z" fill="#0082FB"/><path d="M20.877 9.645l-2.304 1.396c.625 1.27.974 2.799.974 4.334 0 .884-.1 1.65-.267 2.22l2.545.64c.227-.746.338-1.66.338-2.86 0-2.01-.45-3.985-1.286-5.73z" fill="#0082FB"/><path d="M19.273 17.617c-.368 1.22-1.008 1.945-1.765 1.945-1.009 0-1.927-.88-3.5-3.338l-1.627 2.442c1.86 2.966 3.22 4.313 5.128 4.313 2.342 0 3.98-1.854 4.517-4.746l-2.753-.616z" fill="#0082FB"/><path d="M12.003 18.246l-2.148-3.64-1.631 2.45 1.348 2.281c.486.805.954 1.416 1.437 1.867l1.945-2.938c-.32-.29-.62-.702-.951-1.02z" fill="#0082FB"/><path d="M9.245 19.033l-1.345-2.276-2.264 1.317c.88 1.496 1.975 2.44 3.2 2.44.45 0 .888-.12 1.31-.346l-1.945-2.938.044.803z" fill="#0082FB"/><path d="M5.617 18.06l2.264-1.317-1.613-2.727-2.502 1.248c.468.963 1.05 1.887 1.851 2.796z" fill="#0082FB"/><path d="M3.746 15.248l2.502-1.248c-.67-1.133-1.04-2.483-1.04-3.858 0-.385.028-.758.08-1.117l-2.518-.597A10.16 10.16 0 002.5 9.876c0 1.935.46 3.798 1.246 5.372z" fill="#0082FB"/></svg>
